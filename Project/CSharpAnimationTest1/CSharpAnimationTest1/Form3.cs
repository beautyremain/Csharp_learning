...
namespace CSharpAnimationTest1
{
    ...
    public partial class Form3 : Form
    {
        ...
        public Form3(Basic b,Resourse d,string n)
        {
            InitializeComponent();
            this.demand = d;
            this.name = n;
        ...
        public static void preDrawPie(Graphics graphics, SolidBrush solidBrush, SolidBrush solidBrush2, Rectangle rectangle, float angle1, float angle2, int interval)
        {
            ...
            while (true)
            {
                if (Tick == angle2 )
                {
                    ...
                    {
                        graphics.DrawImage(Image.FromFile(@"C:\Users\MyPC\source\repos\Csharp\myProject\CSharpAnimationTest1\CSharpAnimationTest1\Resources\benefits.png"), rectangle);
                        return;
                    }
                }
                if (Tick < 270 - angle1)
